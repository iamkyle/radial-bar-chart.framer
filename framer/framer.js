...
exports.Animation = (function(_super) {
  ...
  Animation.prototype.start = function() {
    var AnimatorClass, k, v, _ref, _ref1,
      _this = this;
    if (this.options.layer === null) {
      console.error("Animation: missing layer");
    }
    if (this.options.layer._animation) {
      this.options.layer._animation.stop();
    }
    this.options.layer._animation = this;
    ...
    if (this.options.delay) {
      return Utils.delay(this.options.delay, this._start);
    } else {
      return this._start();
    }
  };
...
},{"./Animators/BezierCurveAnimator":4,"./Animators/LinearAnimator":5,"./Animators/SpringDHOAnimator":6,"./Animators/SpringRK4Animator":7,"./Config":11,"./Defaults":14,"./EventEmitter":16,"./Frame":22,"./Underscore":31,"./Utils":32}],2:[function(require,module,exports){
var Config, EventEmitter, Utils, _, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.AnimationLoop = (function(_super) {
  ...
  function AnimationLoop() {
    this.start = __bind(this.start, this);
    _ref = AnimationLoop.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
},{"./Config":11,"./EventEmitter":16,"./Underscore":31,"./Utils":32}],3:[function(require,module,exports){
var Config, Utils;
...
},{"./Config":11,"./Utils":32}],4:[function(require,module,exports){
...
},{"../Animator":3,"../Underscore":31,"../Utils":32}],5:[function(require,module,exports){
...
},{"../Animator":3,"../Utils":32}],6:[function(require,module,exports){
var Animator, Utils, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../Animator":3,"../Utils":32}],7:[function(require,module,exports){
...
},{"../Animator":3,"../Utils":32}],8:[function(require,module,exports){
var Layer,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./Layer":25}],9:[function(require,module,exports){
...
},{"./EventEmitter":16,"./Underscore":31,"./Utils":32}],10:[function(require,module,exports){
...
},{"./Layer":25}],11:[function(require,module,exports){
var FramerCSS, Utils;
...
},{"./Config":11,"./EventManager":17,"./Underscore":31,"./Utils":32}],13:[function(require,module,exports){
var Context, EventKeys, Utils, createDebugLayer, errorWarning, hideDebug, showDebug, toggleDebug, _debugContext, _errorContext, _errorShown;
...
showDebug = function() {
  ...
  return _debugContext.run(function() {
    return layerList.map(createDebugLayer);
  });
};

hideDebug = function() {
  return _debugContext.reset();
};
...
},{"./Context":12,"./Utils":32}],14:[function(require,module,exports){
...
},{"./Underscore":31,"./Utils":32}],15:[function(require,module,exports){
...
},{"./BaseClass":9,"./Defaults":14,"./Events":18,"./Layer":25,"./Underscore":31,"./Utils":32}],16:[function(require,module,exports){
var EventEmitter;
...
},{"eventemitter3":34}],17:[function(require,module,exports){
...
},{"./Underscore":31,"./Utils":32}],19:[function(require,module,exports){
exports.MobileScrollFix = require("./MobileScrollFix");

exports.OmitNew = require("./OmitNew");


},{"./MobileScrollFix":20,"./OmitNew":21}],20:[function(require,module,exports){
var Utils,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./BaseClass":9}],23:[function(require,module,exports){
...
},{"./Animation":1,"./AnimationLoop":2,"./Animators/BezierCurveAnimator":4,"./Animators/LinearAnimator":5,"./Animators/SpringDHOAnimator":6,"./Animators/SpringRK4Animator":7,"./BackgroundLayer":8,"./BaseClass":9,"./Compat":10,"./Config":11,"./Context":12,"./Debug":13,"./Defaults":14,"./DeviceView":15,"./EventEmitter":16,"./Events":18,"./Extras/Extras":19,"./Frame":22,"./Importer":24,"./Layer":25,"./LayerStyle":28,"./Print":29,"./Screen":30,"./Underscore":31,"./Utils":32,"./VideoLayer":33}],24:[function(require,module,exports){
...
},{"./Underscore":31,"./Utils":32}],25:[function(require,module,exports){
var Animation, BaseClass, Config, Defaults, EventEmitter, Frame, LayerDraggable, LayerStates, LayerStyle, Utils, layerProperty, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
exports.Layer = (function(_super) {
  ...
  Layer.define("borderRadius", layerProperty(Layer, "borderRadius", "borderRadius", 0, _.isNumber));
...
},{"./Animation":1,"./BaseClass":9,"./Config":11,"./Defaults":14,"./EventEmitter":16,"./Frame":22,"./LayerDraggable":26,"./LayerStates":27,"./LayerStyle":28,"./Underscore":31,"./Utils":32}],26:[function(require,module,exports){
...
},{"./EventEmitter":16,"./Events":18,"./Underscore":31,"./Utils":32}],27:[function(require,module,exports){
...
},{"./BaseClass":9,"./Defaults":14,"./Events":18,"./Underscore":31}],28:[function(require,module,exports){
...
exports.LayerStyle = {
  ...
  webkitTransformPrefer2d: function(layer) {
    ...
    if (layer._properties.scaleX !== 1 || layer._properties.scaleY !== 1 || layer._properties.scaleZ !== 1) {
...
},{"./Context":12,"./Utils":32}],30:[function(require,module,exports){
...
},{"./BaseClass":9}],31:[function(require,module,exports){
var _;
...
},{"lodash":35,"underscore.string":36}],32:[function(require,module,exports){
...
},{"./Screen":30,"./Underscore":31}],33:[function(require,module,exports){
var Layer,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./Layer":25}],34:[function(require,module,exports){
'use strict';
